...
export CDK_SECRET_KEYS=API_TOKENS,DB_DSN,AWS_REGION,MODEL_NAME,SMALL_MODEL,KNOWLEDGE_ADMIN_REQUESTORS,WHATSAPP_META_VERIFY_TOKEN,WHATSAPP_META_APP_SECRET,WHATSAPP_META_ACCESS_TOKEN
./ops/deploy.sh dev default
```
...
```json
{
  ...
  "DB_DSN": "postgresql://...",
  "KNOWLEDGE_ADMIN_REQUESTORS": "chainlit:local,wa-meta:5213325364780",
